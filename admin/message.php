...
<body style="width: 1530px; height: 595px;">
	<?php
	...
	<div class="right_box">
		...
		<div class="msg">
			...
			<br><div class="chat user">
				<div style="float: left; padding-top: 5px;">
					&nbsp
					<img style="height: 45px; width: 45px;border-radius: 50%" src="images/p.jpg">&nbsp
				</div>
		...
		<!--------------------------------Admin------------------------------->
			<br><div class="chat admin">
				<div style="float: left; padding-top: 5px;">
					&nbsp
					<?php
						echo "<img class='img-circle profile_img' height=45 width=45 src='images/".$_SESSION['pic']."'>";
			...
			?>
				...
				else
				{
					...
					{
						?>
							<img style="margin-right: 100px 80px; border-radius: 70%;" src="images/re.jfif">
		...
		<div class="msg">
			...
			<br><div class="chat user">
				<div style="float: left; padding-top: 5px;">
					&nbsp
					<img style="height: 45px; width: 45px;border-radius: 50%" src="images/p.jpg">
					&nbsp
				</div>
				<div style="float: left;" class="chatbox">
					<?php
